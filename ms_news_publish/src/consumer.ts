...
const connection: Connection = await client.connect("amqp://guest:guest@172.22.169.247172.22.169.247:5672")
// Create a channel
...
// Start the consumer 
await channel.consume('newsPublish', async (msg: Message | null) => {   
    if (msg) {
